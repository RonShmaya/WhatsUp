...
public class SpeakingActivity extends AppCompatActivity {
    ...
    private void init_actions() {
        ...
        speaking_IMG_send.setOnClickListener(new View.OnClickListener() {
            ...
            public synchronized void onClick(View view) {
                ...
                if (speaking_TIETL_msg.getText().toString().isEmpty())
                    return;
                if (myUser.getPhone().equals(chat.getChat_id()))
                    return;
                ...
                // TODO: 10/02/2023 listen to changes -> can be updated by the chats activity , for typing, last seen, and in case the messages len grow -> go take new msg
    ...
    public void onBackPressed() {
        super.onBackPressed();
        MyDB.getInstance().setCallback_save_message(null);
        finish();
    }
